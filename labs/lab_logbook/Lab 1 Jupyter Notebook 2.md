...
from pynq.lib.merge import MergeIP

import os
print(os.getcwd())

overlay = Overlay('/home/xilinx/jupyter_notebooks/ws/lab1_fir/Merge/mergeTest.bit') # Modify based on where you put your .bit
```

    /home/xilinx/jupyter_notebooks/ws/lab1_fir/Merge



```python
overlay?
# Should show two IP blocks: merge_v1_0_0, processing_system7_0
```

Type:            Overlay
String form:     <pynq.overlay.Overlay object at 0xb2ed1ad8>
File:            /usr/local/share/pynq-venv/lib/python3.10/site-packages/pynq/overlay.py
Docstring:      
Default documentation for overlay /home/xilinx/jupyter_notebooks/ws/lab1_fir/Merge/mergeTest.bit. The following
attributes are available on this overlay:

IP Blocks
----------
merge_v1_0_0         : pynq.lib.merge.MergeIP
...
```python
result = overlay.merge_v1_0_0.merge(a,b) # modify "merge_v1_0_0" based on how you named the IP during creation
print(result)
```
