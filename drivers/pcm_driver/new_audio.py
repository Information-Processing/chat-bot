...
class AudioDirect(DefaultIP):
    ...
    def record(self, seconds): # changed
        ...
        ----------
        seconds : float
            The number of seconds to be recorded (must be between 0 and 10).
